...
void	draw1(t_game *game, int i, int i2)
{
	if (game->map.map[i][i2] == 'P')
	{
		mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
			game->images.grass, i2 * SCALE2, i * SCALE);
		mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
			game->images.player, i2 * SCALE2, i * SCALE);
		game->players.p_x = i2;
		game->players.p_y = i;
	}
	else if (game->map.map[i][i2] == '1')
	{
		...
		{
			mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
				game->images.wall, i2 * SCALE2, i * SCALE);
		}
		else
		{
			mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
				game->images.grass, i2 * SCALE2, i * SCALE);
			mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
				game->images.tree1, i2 * SCALE2, i * SCALE);
		}
	}
}
...
void	draw3(t_game *game, int i, int i2)
{
	if (game->map.map[i][i2] == 'E')
	{
		mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
			game->images.grass, i2 * SCALE2, i * SCALE);
		mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
			game->images.c_exit, i2 * SCALE2, i * SCALE);
	}
	else
		mlx_put_image_to_window(game->mlx.mlx, game->mlx.win,
			game->images.grass, i2 * SCALE2, i * SCALE);
